...
const (
	Game_SendMessage_FullMethodName      = "/proto.Game/SendMessage"
...
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
//
// Game service for tick-based updates
type GameClient interface {
	// Send a message to the server
	SendMessage(ctx context.Context, in *GameMessage, opts ...grpc.CallOption) (*Empty, error)
...
func (c *gameClient) SendMessage(ctx context.Context, in *GameMessage, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Game_SendMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GameServer interface {
	// Send a message to the server
	SendMessage(context.Context, *GameMessage) (*Empty, error)
	// Subscribe to tick updates
...
func (UnimplementedGameServer) SendMessage(context.Context, *GameMessage) (*Empty, error) {
...
func _Game_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Game_SendMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GameServer).SendMessage(ctx, req.(*GameMessage))
	}
	return interceptor(ctx, in, info, handler)
}
